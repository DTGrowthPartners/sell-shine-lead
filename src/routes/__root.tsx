...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VCC — Vende o arrienda más rápido con pauta digital en Cartagena" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "VCC — Vende o arrienda más rápido con pauta digital en Cartagena" },
      {
        ...
        content:
          "Campañas en Meta Ads dirigidas a compradores e interesados reales en Cartagena. Conversión directa por WhatsApp.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300..500;1,9..144,300..500&family=Geist:wght@300..600&display=swap",
      },
    ],
  }),
